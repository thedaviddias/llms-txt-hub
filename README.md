...
- ![Bun — A fast all favicon](https://www.google.com/s2/favicons?domain=bun.sh&size=128) **[Bun — A fast all](https://bun.sh)** - Bun is a new JavaScript runtime with a native bundler, transpiler, task runner, and npm client built-in. <sub>[llms.txt](https://bun.sh/llms.txt)</sub>
