...
- ![llms.txt favicon](https://www.google.com/s2/favicons?domain=llmstxt.org&size=32) **[llms.txt](https://llmstxt.org/)** - A proposal to standardise on using an /llms.txt file to provide information to help LLMs use a website at inference time. <sub>[llms.txt](https://llmstxt.org/llms.txt)</sub>
